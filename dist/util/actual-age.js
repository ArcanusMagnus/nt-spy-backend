...
exports.nextCyclesOverview = exports.calculateExpiry = exports.calculateAge = void 0;
...
const calculateExpiry = (playerAgeYears, playerAgeDays) => {
    const cyclePhases = {
        4: "Friendly-1",
        11: "Friendly-2",
        18: "CC-M1",
...
const nextCyclesOverview = () => {
    // TODO: #4 table with ideal ages for next phases & time remaining to them
};
exports.nextCyclesOverview = nextCyclesOverview;
